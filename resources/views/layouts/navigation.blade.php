                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        ...
                        @can('create payment')
                            ...
                            <x-nav-link :href="route(
                                $bottelegram ? 'bottelegram.edit' : 'bottelegram.create',
                                $bottelegram ?? '',
                            )" :active="request()->routeIs('bottelegram*')">
                                {{ __('Telegram') }}
                            </x-nav-link>
                        ...
                        <x-nav-link :href="route('bisnis.index')" :active="request()->routeIs('bisnis*')">
                            {{ __('Tunnels Bisnis') }}
                        </x-nav-link>
                    ...
                    <x-dropdown placement="bottom-end">
                        ...
                        <x-slot name="content">
                            ...
                            @can('create payment')
                                ...
                                <x-dropdown-link :href="$paymentCount == 0
                                    ? route('payment.create')
                                    : ($paymentCount == 1
                                        ? route('payment.edit', $payment)
                                        : route('payment.index'))">
